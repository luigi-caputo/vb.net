...
#End Region
    ...
    Dim IpAd As String = "wedcu.no-ip.org"
    ...
    Private Sub frmMain_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        ...
        Try
            ...
            If IsFNIAtt = True Then
                Dim req23 As HttpWebRequest = WebRequest.Create("http://mgo.altervista.org/fnp.txt")
    ...
    Sub Connessione()
        Try 'Gestione errori
            ...
            If client.Connected = True Then 'Verifico se la connessione è riuscita
                ...
                isconn = True
                tmrDati.Enabled = True 'Avvio il timer per ricevere i dati dal client connesso
            End If
